...
# print(f"🔍 DEBUG (api.py): Using MONGO_URI = {MONGO_URI}")
# if not MONGO_URI:
...
# Debug print so you can see if MONGO_URI is loaded correctly
MONGO_URI = os.getenv("MONGO_URI")
...
# ============================
client = MongoClient(MONGO_URI, tlsAllowInvalidCertificates=True)
db = client['insightledger']   # ← This 'db' is now globally available
...
# CORS - Allow your React frontend (localhost:5173)
app.add_middleware(
    CORSMiddleware,
